    ...
    <div className="container mx-auto p-6 max-w-4xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">{tree.treeCode}</h1>
            <p className="text-gray-600 mt-1">
              {tree.section?.plot?.name} → {tree.section?.name} (ต้นที่ {tree.treeNumber})
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {tree.plantedDate && (
                  <div>
                    <label className="text-sm font-medium text-gray-600">วันที่ปลูก</label>
                    <p>{new Date(tree.plantedDate).toLocaleDateString('th-TH')}</p>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-gray-600">สถานะต้นไม้</label>
                  <div className="mt-1">
                ...
                <div>
                  <label className="text-sm font-medium text-gray-600">สถานะการออกดอก</label>
                  <div className="mt-1">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-gray-600">แปลง</label>
                  <p className="text-lg">
                  ...
                  {tree.logs.map((log) => (
                    <div key={log.id} className="border rounded-lg p-4">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        {log.healthStatus && (
                          <div>
                            {getHealthStatusBadge(log.healthStatus)}
                          </div>
                        )}
                      </div>
